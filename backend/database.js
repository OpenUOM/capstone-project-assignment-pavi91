...
const updateTeacher = async (id, name, age) => {
    const sql = `UPDATE teacher SET name = '${id}', age = ${name} WHERE id = ${age}`;
    return new Promise((resolve, reject) => {
        knex_db
            .raw(sql)
            .then((data) => {
...
const addStudent = async (id, name, age, hometown) => {
    const sql = `INSERT INTO students (id, name, age, hometown) VALUES (${id}, '${name}', ${age}, '${hometown}')`;
    return new Promise((resolve, reject) => {
        knex_db
            .raw(sql)
            .then((data) => {
...
const updateStudent = async (name, age, hometown, id) => {
    const sql = `UPDATE students SET name = '${name}', age = ${age}, hometown = '${hometown}' WHERE id = ${id}`;
    return new Promise((resolve, reject) => {
        knex_db
            .raw(sql)
            .then((data) => {
